...
## Complete Facebook Marketplace & Craigslist Listing Template

---

## PHOTOS (Upload in this order):

1. [PHOTO 1] Front 3/4 angle - Show induction wheels and front design
2. [PHOTO 2] Interior dashboard - Show 15" touchscreen and white interior
3. [PHOTO 3] Driver side profile - Full side view
4. [PHOTO 4] Cargo area - Trunk with all-weather mat
5. [PHOTO 5] Roof rack close-up - Tesla OEM rack installed
6. [PHOTO 6] Tow hitch - Show connector attached
7. [PHOTO 7] Rear 3/4 angle - Show tail lights and overall profile
8. [PHOTO 8] Frunk - Front trunk storage
...
## LISTING TITLE (Facebook/Craigslist):

**2024 Tesla Model Y AWD - Adventure Tech Package - Camp Mode - CPO Warranty**
...
**OPTIONAL ADD-ON: INNO 2-Bike Hitch Rack**

- Willing to include Inno 2-bike hitch rack for additional $300
- Platform-style design, fits 2 bikes
- Tilts down for trunk access with bikes loaded
- Retail value: $400+
- Perfect companion for this adventure-ready Tesla
...
- Premium Connectivity - Real-time traffic monitoring, satellite maps, streaming music ($10/month)
- Sentry Mode - 360-degree cameras record when parked, excellent theft deterrent
- 256GB USB Storage Included - Dashcam and Sentry Mode footage storage
- Over-the-Air Updates - Car gets better over time with free software updates
...
- Insurance: Approximately $150/month through Tesla Insurance
- Charging at home: $30-50/month (compared to $200+ for gasoline)
- Maintenance: Minimal - no oil changes, brake fluid replacement every 2 years only
- Premium Connectivity: $10/month (optional but highly recommended)
- Total Monthly Operating Cost: Approximately $190-210 (compared to $400+ for comparable gas vehicle)
...
**NOT INCLUDED / NOT ACCEPTED**

- No scams or sketchy offers
- No trades - cash sale only
- No tire kickers
...
- [ ] Upload 10-12 photos in order listed above
- [ ] Copy description (without photo placeholders)
- [ ] Price: $34,900
...
CRAIGSLIST:
- [ ] Upload 12+ photos (Craigslist allows more)
- [ ] Copy full description
- [ ] Price: $34,900
- [ ] Location: Santa Cruz
- [ ] Section: cars & trucks - by owner
- [ ] Include your phone number for serious buyers

REDDIT (r/TeslaModelY, r/VanLife):
- [ ] Shorten description to key highlights
- [ ] Include link to full Craigslist ad
- [ ] Be active in comments answering questions

TESLA FORUMS:
- [ ] Post in "Vehicles for Sale" section
- [ ] Emphasize CPO warranty and upgrades
- [ ] Tesla owners appreciate detailed specs
...
Negotiation Points to Emphasize:
- $4,000+ in upgrades included (roof rack, tow hitch, tint, camping gear, mats, mud flaps)
- CPO warranty with 60k miles remaining
- Operating costs are $190/month versus $400+ for gas SUV = $2,500+/year in savings
...
- This template has NO EMOJIS or checkmarks for clean professional appearance
- All photos are clearly labeled with placeholders
- Description is complete and detailed for copy-paste to any platform
- Pricing strategy included for negotiations
- Optional bike rack is a great add-on to close deals
